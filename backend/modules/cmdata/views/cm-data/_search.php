    ...
    <div class="col-md-12">
        <div class="col-md-3">
            ...
            <?= $form->field($searchModel, 'country', [
                ...
                'initValueText' => !empty($params['CmDataSearch']['country']) ? \backend\models\AppsCountries::findOne($searchModel->country)->country_name : '',
//                'value' => $searchModel->country,
        ...
        <div class="col-md-3">
            ...
            <?= $form->field($searchModel, 'language', [
                ...
                'theme' => Select2::THEME_DEFAULT,
                'initValueText' => !empty($params['CmDataSearch']['language']) ? \backend\models\Languages::findOne($searchModel->language)->name : '',
    ...
    <div class="col-md-12">
        <div class="col-md-3">
            <?= $form->field($searchModel, 'sub_cat_id', [
            ])->widget(Select2::classname(), [
                'theme' => Select2::THEME_DEFAULT,
        ...
        <div class="col-md-3">
            <?= $form->field($searchModel, 'product', [
            ])->widget(Select2::classname(), [
                'theme' => Select2::THEME_DEFAULT,
...
//            print_r($data);die;
            ?>
            <?= $form->field($searchModel, 'media_type', [
            ])->widget(Select2::classname(), [
                'theme' => Select2::THEME_DEFAULT,
...
//                        'minimumInputLength' => 3,
    ...
    <div class="col-md-12">
        ...
        <div class="col-md-3">
            <?= $form->field($searchModel, 'ad_form', [
            ])->widget(Select2::classname(), [
                'theme' => Select2::THEME_DEFAULT,
////                'initValueText' => !empty($params) ? \backend\models\Languages::findOne($searchModel->language)->name : '',                'options' => ['multiple' => false, 'placeholder' => 'Search Ad From ...'],
                'pluginOptions' => [
                    'allowClear' => true,
                    'language' => [
                        'errorLoading' => new yii\web\JsExpression("function () { return 'Waiting for results...'; }"),
                    ...
                    'ajax' => [
                        'url' => yii\helpers\Url::to(['/cmdata/cm-data/get-ad-form-list']),
                        'dataType' => 'json',
                        'results' => new yii\web\JsExpression('function(data) { return data }')
                    ],
                ],
        ...
        <div class="col-md-3">
            <?= $form->field($searchModel, 'tags', [
                ...
                'theme' => Select2::THEME_DEFAULT,
//        'data' => $itemCategory,
                'options' => ['multiple' => false, 'placeholder' => 'Search Tag ...'],
                'pluginOptions' => [
                    'allowClear' => true,
                    'minimumInputLength' => 3,
                    'language' => [
                    ...
                    'ajax' => [
                        'url' => yii\helpers\Url::to(['/cmdata/cm-data/get-tag-list']),
                        'dataType' => 'json',
                        'results' => new yii\web\JsExpression('function(data) { return data }')
                    ],
                ],
