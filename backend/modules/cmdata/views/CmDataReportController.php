...
class CmDataReportController extends Controller
{
    ...
    public function actionGetLanguageList($term = null,$id = null){
        ...
        if (!is_null($term)) {
            ...
            $ct = ArrayHelper::toArray(Languages::find($id));
            $out['results'] = ['id' => $ct['name'], 'text' => $ct['name']];
        }
        return $out;
    }
    public function actionGetCountryList($term = null,$id=null){
        \Yii::$app->response->format = \yii\web\Response::FORMAT_JSON;
        $out = ['results' => ['id' => '', 'text' => '']];
        if (!is_null($term)) {
            $query = new \yii\db\Query;
            ...
            $ct = ArrayHelper::toArray(AppsCountries::find($id));
            $out['results'] = ['id' => $ct['country_name'], 'text' => $ct['country_name']];
        }
        return $out;
    }
